...
{
    public class Mini_Slider_Master
    {
        ...
        [Column("discount_percentage", Order = 10, TypeName = "text")]
        public string? discount_percentage { get; set; }

        [Column("slider_category", Order = 11, TypeName = "text")]
        public string? slider_category { get; set; }

        [Column("slider_category_id", Order = 12, TypeName = "bigint")]
        public long? slider_category_id { get; set; }

        [Column("slider_status", Order = 13, TypeName = "bigint")]
        public int slider_status { get; set; } = 0;
