...
{
   [Table ("texla1_13022022_141659")] 
       
   public class Texla1_13022022_141659
   {
       ...
       [Column("dob", Order = 24, TypeName = "varchar(50)")]
       ...
       [Column("dactive", Order = 28, TypeName = "varchar(100)")]
       public string? dactive { get; set; }

       [Column("taxcode", Order = 29, TypeName = "varchar(100)")]
       ...
       [Column("n_nsdl_id_1", Order = 47, TypeName = "varchar(16)")]
       public string? n_nsdl_id_1 { get; set; }

       [Column("n_nsdl_id_2", Order = 48, TypeName = "varchar(16)")]
       public string? n_nsdl_id_2 { get; set; }

       [Column("n_cdsl_id_1", Order = 49, TypeName = "varchar(16)")]
       public string? n_cdsl_id_1 { get; set; }

       [Column("n_cl_id", Order = 50, TypeName = "varchar(16)")]
       ...
       [Column("after_sebi_notice_1_yn", Order = 72, TypeName = "varchar(50)")]
       public string? after_sebi_notice_1_yn { get; set; }

       [Column("after_sebi_notice_2_yn", Order = 73, TypeName = "varchar(50)")]
       public string? after_sebi_notice_2_yn { get; set; }

       [Column("after_sebi_notice_3_yn", Order = 74, TypeName = "varchar(50)")]
