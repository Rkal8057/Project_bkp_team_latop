...
{
   [Table ("tr_duplicate_deleted")] 
       
   public class Tr_Duplicate_Deleted
   {
       ...
       [Column("shares", Order = 16, TypeName = "float")]
       public long? shares { get; set; }

       [Column("rcshare", Order = 17, TypeName = "float")]
       public long? rcshare { get; set; }

       [Column("old_sahre_qty", Order = 18, TypeName = "float")]
       public long? old_sahre_qty { get; set; }

       [Column("camount", Order = 19, TypeName = "float")]
       public long? camount { get; set; }

       [Column("share_type", Order = 20, TypeName = "varchar(50)")]
       public string? share_type { get; set; }

       [Column("stamp_duty", Order = 21, TypeName = "float")]
       public long? stamp_duty { get; set; }

       [Column("trfdate", Order = 22, TypeName = "datetime")]
       public DateTime? trfdate { get; set; }

       [Column("recdate", Order = 23, TypeName = "datetime")]
       public DateTime? recdate { get; set; }

       [Column("dmdate", Order = 24, TypeName = "datetime")]
       public DateTime? dmdate { get; set; }

       [Column("old_exchange_type", Order = 25, TypeName = "varchar(250)")]
       public string? old_exchange_type { get; set; }

       [Column("prindt", Order = 26, TypeName = "datetime")]
       public DateTime? prindt { get; set; }

       [Column("prfolio", Order = 27, TypeName = "varchar(16)")]
       public string? prfolio { get; set; }

       [Column("dpidno", Order = 28, TypeName = "varchar(16)")]
       public string? dpidno { get; set; }

       [Column("clinid", Order = 29, TypeName = "varchar(16)")]
       public string? clinid { get; set; }

       [Column("printcode", Order = 30, TypeName = "varchar(100)")]
       public string? printcode { get; set; }

       [Column("sellcode", Order = 31, TypeName = "varchar(100)")]
       public string? sellcode { get; set; }

       [Column("purcode", Order = 32, TypeName = "varchar(100)")]
       public string? purcode { get; set; }

       [Column("cvcode", Order = 33, TypeName = "varchar(100)")]
       public string? cvcode { get; set; }

       [Column("rtag", Order = 34, TypeName = "varchar(100)")]
       public string? rtag { get; set; }

       [Column("rejres", Order = 35, TypeName = "varchar(100)")]
       public string? rejres { get; set; }

       [Column("rflag", Order = 36, TypeName = "varchar(100)")]
       public string? rflag { get; set; }

       [Column("csflag", Order = 37, TypeName = "varchar(100)")]
       public string? csflag { get; set; }

       [Column("panno", Order = 38, TypeName = "varchar(20)")]
       public string? panno { get; set; }

       [Column("derno", Order = 39, TypeName = "varchar(250)")]
       public string? derno { get; set; }

       [Column("derno_rrno", Order = 40, TypeName = "varchar(250)")]
       public string? derno_rrno { get; set; }

       [Column("req_no", Order = 41, TypeName = "varchar(50)")]
       public string? req_no { get; set; }

       [Column("req_date", Order = 42, TypeName = "datetime")]
       public DateTime? req_date { get; set; }

       [Column("req_comp_date", Order = 43, TypeName = "datetime")]
       public DateTime? req_comp_date { get; set; }

       [Column("req_foliono", Order = 44, TypeName = "varchar(50)")]
       public string? req_foliono { get; set; }

       [Column("req_folio_name", Order = 45, TypeName = "varchar(50)")]
       public string? req_folio_name { get; set; }

       [Column("value_date", Order = 46, TypeName = "datetime")]
       public DateTime? value_date { get; set; }

       [Column("entey_date", Order = 47, TypeName = "datetime")]
       public DateTime? entey_date { get; set; }

       [Column("user_name", Order = 48, TypeName = "varchar(50)")]
       public string? user_name { get; set; }

       [Column("computer_id", Order = 49, TypeName = "varchar(50)")]
       public string? computer_id { get; set; }

       [Column("t_panno", Order = 50, TypeName = "varchar(20)")]
       public string? t_panno { get; set; }

       [Column("t_names", Order = 51, TypeName = "varchar(50)")]
       public string? t_names { get; set; }

       [Column("t_fname", Order = 52, TypeName = "varchar(50)")]
       public string? t_fname { get; set; }

       [Column("t_email", Order = 53, TypeName = "varchar(50)")]
       public string? t_email { get; set; }

       [Column("t_mobile", Order = 54, TypeName = "varchar(50)")]
       public string? t_mobile { get; set; }

       [Column("t_dp_id_1", Order = 55, TypeName = "varchar(16)")]
       public string? t_dp_id_1 { get; set; }

       [Column("t_cl_id_2", Order = 56, TypeName = "varchar(16)")]
       public string? t_cl_id_2 { get; set; }

       [Column("t_sta", Order = 57, TypeName = "varchar(30)")]
       public string? t_sta { get; set; }

       [Column("t_m_f", Order = 58, TypeName = "varchar(20)")]
       public string? t_m_f { get; set; }

       [Column("t_dob", Order = 59, TypeName = "varchar(25)")]
       public string? t_dob { get; set; }

       [Column("t_emailid", Order = 60, TypeName = "varchar(50)")]
       public string? t_emailid { get; set; }

       [Column("t_phone", Order = 61, TypeName = "varchar(100)")]
       public string? t_phone { get; set; }

       [Column("reject_code", Order = 62, TypeName = "varchar(50)")]
       public string? reject_code { get; set; }

       [Column("reject_remark", Order = 63, TypeName = "varchar(50)")]
       public string? reject_remark { get; set; }

       [Column("create_new", Order = 64, TypeName = "varchar(100)")]
       public string? create_new { get; set; }

       [Column("p_panno", Order = 65, TypeName = "varchar(20)")]
       public string? p_panno { get; set; }

       [Column("p_names", Order = 66, TypeName = "varchar(50)")]
       public string? p_names { get; set; }

       [Column("p_fname", Order = 67, TypeName = "varchar(50)")]
       public string? p_fname { get; set; }

       [Column("p_email", Order = 68, TypeName = "varchar(50)")]
       public string? p_email { get; set; }

       [Column("p_mobile", Order = 69, TypeName = "varchar(50)")]
       public string? p_mobile { get; set; }

       [Column("p_dp_id_1", Order = 70, TypeName = "varchar(16)")]
       public string? p_dp_id_1 { get; set; }

       [Column("p_cl_id_2", Order = 71, TypeName = "varchar(16)")]
       public string? p_cl_id_2 { get; set; }

       [Column("p_sta", Order = 72, TypeName = "varchar(30)")]
       public string? p_sta { get; set; }

       [Column("p_m_f", Order = 73, TypeName = "varchar(20)")]
       public string? p_m_f { get; set; }

       [Column("p_dob", Order = 74, TypeName = "varchar(15)")]
       public string? p_dob { get; set; }

       [Column("p_emailid", Order = 75, TypeName = "varchar(50)")]
       public string? p_emailid { get; set; }

       [Column("p_phone", Order = 76, TypeName = "varchar(100)")]
       public string? p_phone { get; set; }

       [Column("multiple_folio", Order = 77, TypeName = "varchar(3)")]
       public string? multiple_folio { get; set; }

       [Column("rr_flag_name", Order = 78, TypeName = "varchar(50)")]
       public string? rr_flag_name { get; set; }

       [Column("trx_remark", Order = 79, TypeName = "varchar(50)")]
       public string? trx_remark { get; set; }

       [Column("reject_code_grid", Order = 80, TypeName = "varchar(50)")]
       public string? reject_code_grid { get; set; }

       [Column("reject_remark_grid", Order = 81, TypeName = "varchar(50)")]
       public string? reject_remark_grid { get; set; }

       [Column("share_accept_yn_13_05_2022_t45_16_45_51", Order = 82, TypeName = "varchar(3)")]
       public string? share_accept_yn_13_05_2022_t45_16_45_51 { get; set; }

       [Column("old_distno_new", Order = 83, TypeName = "varchar(50)")]
       public string? old_distno_new { get; set; }

       [Column("t_ad1", Order = 84, TypeName = "varchar(50)")]
       public string? t_ad1 { get; set; }

       [Column("t_ad2", Order = 85, TypeName = "varchar(50)")]
       public string? t_ad2 { get; set; }

       [Column("t_city", Order = 86, TypeName = "varchar(50)")]
       public string? t_city { get; set; }

       [Column("t_state", Order = 87, TypeName = "varchar(50)")]
       public string? t_state { get; set; }

       [Column("t_pincode", Order = 88, TypeName = "varchar(50)")]
       public string? t_pincode { get; set; }

       [Column("t_country_name", Order = 89, TypeName = "varchar(50)")]
       public string? t_country_name { get; set; }

       [Column("p_ad1", Order = 90, TypeName = "varchar(50)")]
       public string? p_ad1 { get; set; }

       [Column("p_ad2", Order = 91, TypeName = "varchar(50)")]
       public string? p_ad2 { get; set; }

       [Column("p_city", Order = 92, TypeName = "varchar(50)")]
       public string? p_city { get; set; }

       [Column("p_state", Order = 93, TypeName = "varchar(50)")]
       public string? p_state { get; set; }

       [Column("p_pincode", Order = 94, TypeName = "varchar(50)")]
       public string? p_pincode { get; set; }

       [Column("p_country_name", Order = 95, TypeName = "varchar(50)")]
       public string? p_country_name { get; set; }

       [Column("vou_action_type", Order = 96, TypeName = "varchar(50)")]
       ...
       [Column("comp_sno", Order = 146, TypeName = "float")]
       public long? comp_sno { get; set; }

       [Column("comp_isin", Order = 147, TypeName = "varchar(50)")]
       public string? comp_isin { get; set; }

       [Column("comp_name", Order = 148, TypeName = "varchar(50)")]
       public string? comp_name { get; set; }

       [Column("comp_name_short", Order = 149, TypeName = "varchar(50)")]
