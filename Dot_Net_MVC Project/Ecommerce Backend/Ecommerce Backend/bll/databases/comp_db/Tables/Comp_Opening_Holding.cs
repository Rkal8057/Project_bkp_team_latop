...
{
   [Table ("comp_opening_holding")] 
       
   public class Comp_Opening_Holding
   {
       [Key, Column("id", Order = 1, TypeName = " bigint(10) auto_increment"), Required]
       public long? id { get; set; }
       
       [Column("comp_opening_holding_auto_id", Order = 2, TypeName = "bigint(10)")]
       public long? comp_opening_holding_auto_id { get; set; }
