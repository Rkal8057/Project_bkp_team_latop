...
namespace Rta.Controllers.Masters
{
    ...
    public class HelperMasterController : Controller
    {
        ...
        public IActionResult GetHelperMaster()
        {
            try
            {
                RTA.Masters.HelperMasterBLL sample = new HelperMasterBLL(DBConnStr);
                var Res = sample.GetHelperMaster();
        ...
        [HttpPost("create")]
        [Produces("application/json", Type = typeof(HelperMasterResp))]
        public IActionResult AddHelperMaster([FromBody] HelperMasterReq samp, [FromHeader] long Token_ID,
        ...
        [HttpPut("update")]
        [Produces("application/json", Type = typeof(HelperMasterResp))]
        public IActionResult UpdateHelperMaster([FromHeader] long Token_ID,
            [FromHeader] string Token_Data, long helperId, [FromBody] HelperMasterReq samp)
        {
            try
            {
        ...
        [HttpDelete("delete")]
        [Produces("application/json", Type = typeof(HelperMasterResp))]
        public IActionResult DeleteHelperMaster(long helperId, [FromHeader] long Token_ID,
            [FromHeader] string Token_Data)
        {
            try
            {
