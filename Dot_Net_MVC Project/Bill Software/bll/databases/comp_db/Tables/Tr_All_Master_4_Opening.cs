...
{
   [Table ("tr_all_master_4_opening")] 
       
   public class Tr_All_Master_4_Opening
   {
       ...
       [Column("share_accept_yn_13_05_2022_t45_16_45_51", Order = 109, TypeName = "varchar(50)")]
       ...
       [Column("bepos_record_id", Order = 153, TypeName = "bigint(10)")]
       public long? bepos_record_id { get; set; }
