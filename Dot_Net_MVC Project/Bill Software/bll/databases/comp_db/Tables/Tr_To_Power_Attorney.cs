...
{
   [Table ("tr_to_power_attorney")] 
       
   public class Tr_To_Power_Attorney
   {
       ...
       [Column("p_names_2", Order = 105, TypeName = "varchar(50)")]
       public string? p_names_2 { get; set; }

       [Column("p_names_3", Order = 106, TypeName = "varchar(50)")]
       public string? p_names_3 { get; set; }

       [Column("t_names_2", Order = 107, TypeName = "varchar(50)")]
       public string? t_names_2 { get; set; }

       [Column("t_names_3", Order = 108, TypeName = "varchar(50)")]
       public string? t_names_3 { get; set; }

       [Column("demat_cum_trx_no", Order = 109, TypeName = "varchar(50)")]
       public string? demat_cum_trx_no { get; set; }

       [Column("p_panno2", Order = 110, TypeName = "varchar(50)")]
       public string? p_panno2 { get; set; }

       [Column("t_panno3", Order = 111, TypeName = "varchar(50)")]
       public string? t_panno3 { get; set; }

       [Column("p_panno3", Order = 112, TypeName = "varchar(50)")]
       public string? p_panno3 { get; set; }

       [Column("t_panno2", Order = 113, TypeName = "varchar(50)")]
