...
namespace Rta.Controllers.Masters
{
    ...
    public class HelperMasterController : Controller
    {
        ...
        public IActionResult GetAllHelperMaster(
            ...
            [FromHeader] string Token_Data, int pageNo, int limit, string? searchKey = null)
        {
            try
            {
                ...
                if (commonAuth.VerifyFormRights(modelAuth, 1, "DELETE"))
                {
                    ...
                    var Res = sample.GetAllHelperMaster(pageNo, limit, searchKey);
        ...
        [HttpGet("detailById")]
        [Produces("application/json", Type = typeof(HelperMasterResp))]
        public IActionResult GetHelperMasterById(
            [FromHeader] long Token_ID,
            [FromHeader] string Token_Data,
            long helperId)
        {
        ...
        [HttpPost("create")]
        [Produces("application/json", Type = typeof(HelperMasterResp))]
        public IActionResult AddHelperMaster(
            [FromHeader] long Token_ID,
            [FromHeader] string Token_Data,
            [FromBody] HelperMasterReq samp)
        {
            try
            {
                ModelAuth modelAuth = commonAuth.Login_Auth(Token_ID, Token_Data);
        ...
        [HttpDelete("delete")]
        [Produces("application/json", Type = typeof(HelperMasterResp))]
        public IActionResult DeleteHelperMaster(
            [FromHeader] long Token_ID,
            [FromHeader] string Token_Data,
            long helperId)
        {
