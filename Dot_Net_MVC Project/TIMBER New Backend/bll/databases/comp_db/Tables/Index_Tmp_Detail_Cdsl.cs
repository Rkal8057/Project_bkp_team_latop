...
{
   [Table ("index_tmp_detail_cdsl")] 
       
   public class Index_Tmp_Detail_Cdsl
   {
       ...
       [Column("dpid", Order = 20, TypeName = "varchar(8)")]
       public string? dpid { get; set; }

       [Column("cl_id", Order = 21, TypeName = "varchar(8)")]
       public string? cl_id { get; set; }

       [Column("fstnm", Order = 22, TypeName = "varchar(164)")]
       public string? fstnm { get; set; }

       [Column("sndnm", Order = 23, TypeName = "varchar(164)")]
       public string? sndnm { get; set; }

       [Column("thdnm", Order = 24, TypeName = "varchar(164)")]
       public string? thdnm { get; set; }

       [Column("nomination_name", Order = 25, TypeName = "varchar(142)")]
       public string? nomination_name { get; set; }

       [Column("fname", Order = 26, TypeName = "varchar(50)")]
       ...
       [Column("city", Order = 33, TypeName = "varchar(25)")]
       public string? city { get; set; }

       [Column("state", Order = 34, TypeName = "varchar(25)")]
       public string? state { get; set; }

       [Column("country", Order = 35, TypeName = "varchar(25)")]
       public string? country { get; set; }

       [Column("pincode", Order = 36, TypeName = "varchar(10)")]
       public string? pincode { get; set; }

       [Column("dob", Order = 37, TypeName = "datetime")]
       public DateTime? dob { get; set; }

       [Column("bankdet", Order = 38, TypeName = "varchar(100)")]
       public string? bankdet { get; set; }

       [Column("bank_ac_no", Order = 39, TypeName = "varchar(20)")]
       public string? bank_ac_no { get; set; }

       [Column("bank_name", Order = 40, TypeName = "varchar(100)")]
       public string? bank_name { get; set; }

       [Column("bank_add1", Order = 41, TypeName = "varchar(40)")]
       public string? bank_add1 { get; set; }

       [Column("bank_add2", Order = 42, TypeName = "varchar(40)")]
       public string? bank_add2 { get; set; }

       [Column("bank_add3", Order = 43, TypeName = "varchar(40)")]
       public string? bank_add3 { get; set; }

       [Column("bank_ifsc_code", Order = 44, TypeName = "varchar(12)")]
       public string? bank_ifsc_code { get; set; }

       [Column("bank_micrno", Order = 45, TypeName = "varchar(12)")]
       public string? bank_micrno { get; set; }

       [Column("bank_city", Order = 46, TypeName = "varchar(25)")]
       public string? bank_city { get; set; }

       [Column("bank_pincode", Order = 47, TypeName = "varchar(10)")]
       public string? bank_pincode { get; set; }

       [Column("bank_state", Order = 48, TypeName = "varchar(25)")]
       public string? bank_state { get; set; }

       [Column("bank_country", Order = 49, TypeName = "varchar(25)")]
       public string? bank_country { get; set; }

       [Column("mobno", Order = 50, TypeName = "varchar(17)")]
       ...
       [Column("blockreaso", Order = 53, TypeName = "varchar(17)")]
       public string? blockreaso { get; set; }

       [Column("foliono_number", Order = 54, TypeName = "varchar(8)")]
       public string? foliono_number { get; set; }

       [Column("phy_cdsl_nsdl", Order = 55, TypeName = "varchar(4)")]
       ...
       [Column("cate_1_code", Order = 69, TypeName = "bigint(10)")]
       ...
       [Column("cate_exchange_name", Order = 75, TypeName = "varchar(4)")]
