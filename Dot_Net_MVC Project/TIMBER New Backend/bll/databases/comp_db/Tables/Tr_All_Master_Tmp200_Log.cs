...
{
   [Table ("tr_all_master_tmp200_log")] 
       
   public class Tr_All_Master_Tmp200_Log
   {
       ...
       [Column("p_adhaar_no", Order = 96, TypeName = "varchar(30)")]
       public string? p_adhaar_no { get; set; }

       [Column("p_voter_id", Order = 97, TypeName = "varchar(30)")]
       public string? p_voter_id { get; set; }

       [Column("p_dl_no", Order = 98, TypeName = "varchar(30)")]
       public string? p_dl_no { get; set; }

       [Column("p_passport_no", Order = 99, TypeName = "varchar(30)")]
       public string? p_passport_no { get; set; }

       [Column("t_adhaar_no", Order = 100, TypeName = "varchar(30)")]
       public string? t_adhaar_no { get; set; }

       [Column("t_voter_id", Order = 101, TypeName = "varchar(30)")]
       public string? t_voter_id { get; set; }

       [Column("t_dl_no", Order = 102, TypeName = "varchar(30)")]
       public string? t_dl_no { get; set; }

       [Column("t_passport_no", Order = 103, TypeName = "varchar(30)")]
       public string? t_passport_no { get; set; }

       [Column("p_names_2", Order = 104, TypeName = "varchar(50)")]
       public string? p_names_2 { get; set; }

       [Column("p_names_3", Order = 105, TypeName = "varchar(50)")]
       public string? p_names_3 { get; set; }

       [Column("t_names_2", Order = 106, TypeName = "varchar(50)")]
       public string? t_names_2 { get; set; }

       [Column("t_names_3", Order = 107, TypeName = "varchar(50)")]
       public string? t_names_3 { get; set; }

       [Column("demat_cum_trx_no", Order = 108, TypeName = "varchar(50)")]
       public string? demat_cum_trx_no { get; set; }

       [Column("p_panno2", Order = 109, TypeName = "varchar(50)")]
       public string? p_panno2 { get; set; }

       [Column("t_panno3", Order = 110, TypeName = "varchar(50)")]
       public string? t_panno3 { get; set; }

       [Column("p_panno3", Order = 111, TypeName = "varchar(50)")]
       public string? p_panno3 { get; set; }

       [Column("t_panno2", Order = 112, TypeName = "varchar(50)")]
       public string? t_panno2 { get; set; }

       [Column("t_folio_address", Order = 113, TypeName = "varchar(50)")]
       public string? t_folio_address { get; set; }

       [Column("p_folio_address", Order = 114, TypeName = "varchar(50)")]
       public string? p_folio_address { get; set; }

       [Column("t_bank_ac_no", Order = 115, TypeName = "varchar(55)")]
       public string? t_bank_ac_no { get; set; }

       [Column("t_account_type", Order = 116, TypeName = "varchar(55)")]
       public string? t_account_type { get; set; }

       [Column("t_bank_name", Order = 117, TypeName = "varchar(50)")]
       public string? t_bank_name { get; set; }

       [Column("t_bank_micrno", Order = 118, TypeName = "varchar(55)")]
       public string? t_bank_micrno { get; set; }

       [Column("t_bank_ifsc_code", Order = 119, TypeName = "varchar(55)")]
       public string? t_bank_ifsc_code { get; set; }

       [Column("t_bank_add1", Order = 120, TypeName = "varchar(50)")]
       public string? t_bank_add1 { get; set; }

       [Column("t_bank_add2", Order = 121, TypeName = "varchar(50)")]
       public string? t_bank_add2 { get; set; }

       [Column("t_bank_add3", Order = 122, TypeName = "varchar(50)")]
       public string? t_bank_add3 { get; set; }

       [Column("t_bank_city", Order = 123, TypeName = "varchar(100)")]
       public string? t_bank_city { get; set; }

       [Column("t_bank_state", Order = 124, TypeName = "varchar(100)")]
       public string? t_bank_state { get; set; }

       [Column("t_bank_pincode", Order = 125, TypeName = "varchar(25)")]
       public string? t_bank_pincode { get; set; }

       [Column("t_bank_country", Order = 126, TypeName = "varchar(100)")]
       public string? t_bank_country { get; set; }

       [Column("p_bank_ac_no", Order = 127, TypeName = "varchar(55)")]
       public string? p_bank_ac_no { get; set; }

       [Column("p_account_type", Order = 128, TypeName = "varchar(55)")]
       public string? p_account_type { get; set; }

       [Column("p_bank_name", Order = 129, TypeName = "varchar(50)")]
       public string? p_bank_name { get; set; }

       [Column("p_bank_micrno", Order = 130, TypeName = "varchar(55)")]
       public string? p_bank_micrno { get; set; }

       [Column("p_bank_ifsc_code", Order = 131, TypeName = "varchar(55)")]
       public string? p_bank_ifsc_code { get; set; }

       [Column("p_bank_add1", Order = 132, TypeName = "varchar(50)")]
       public string? p_bank_add1 { get; set; }

       [Column("p_bank_add2", Order = 133, TypeName = "varchar(50)")]
       public string? p_bank_add2 { get; set; }

       [Column("p_bank_add3", Order = 134, TypeName = "varchar(50)")]
       public string? p_bank_add3 { get; set; }

       [Column("p_bank_city", Order = 135, TypeName = "varchar(100)")]
       public string? p_bank_city { get; set; }

       [Column("p_bank_state", Order = 136, TypeName = "varchar(100)")]
       public string? p_bank_state { get; set; }

       [Column("p_bank_pincode", Order = 137, TypeName = "varchar(25)")]
       public string? p_bank_pincode { get; set; }

       [Column("p_bank_country", Order = 138, TypeName = "varchar(100)")]
       public string? p_bank_country { get; set; }

       [Column("mis_match_present_yn", Order = 139, TypeName = "varchar(1)")]
       public string? mis_match_present_yn { get; set; }

       [Column("mis_match_detail", Order = 140, TypeName = "varchar(50)")]
       public string? mis_match_detail { get; set; }

       [Column("name_mismatch_yn", Order = 141, TypeName = "varchar(1)")]
       public string? name_mismatch_yn { get; set; }

       [Column("name_mismatch_yn_code", Order = 142, TypeName = "varchar(10)")]
       public string? name_mismatch_yn_code { get; set; }

       [Column("share_accept_yn", Order = 143, TypeName = "varchar(50)")]
       public string? share_accept_yn { get; set; }

       [Column("share_price", Order = 144, TypeName = "float")]
       public long? share_price { get; set; }

       [Column("pan1_addhar_linked_yn", Order = 145, TypeName = "varchar(3)")]
       public string? pan1_addhar_linked_yn { get; set; }

       [Column("pan2_addhar_linked_yn", Order = 146, TypeName = "varchar(3)")]
       public string? pan2_addhar_linked_yn { get; set; }

       [Column("pan3_addhar_linked_yn", Order = 147, TypeName = "varchar(3)")]
       public string? pan3_addhar_linked_yn { get; set; }

       [Column("comp_sno", Order = 148, TypeName = "float")]
       public long? comp_sno { get; set; }

       [Column("comp_isin", Order = 149, TypeName = "varchar(50)")]
       public string? comp_isin { get; set; }

       [Column("comp_name", Order = 150, TypeName = "varchar(50)")]
       public string? comp_name { get; set; }

       [Column("comp_name_short", Order = 151, TypeName = "varchar(50)")]
       public string? comp_name_short { get; set; }

       [Column("email_address_rta", Order = 152, TypeName = "varchar(50)")]
       public string? email_address_rta { get; set; }

       [Column("website_address_rta", Order = 153, TypeName = "varchar(50)")]
       public string? website_address_rta { get; set; }

       [Column("company_name_rta", Order = 154, TypeName = "varchar(50)")]
       public string? company_name_rta { get; set; }

       [Column("compliance_officer_current", Order = 155, TypeName = "varchar(50)")]
       public string? compliance_officer_current { get; set; }

       [Column("maker_make_current", Order = 156, TypeName = "varchar(50)")]
       public string? maker_make_current { get; set; }

       [Column("checker_name_current", Order = 157, TypeName = "varchar(50)")]
       public string? checker_name_current { get; set; }

       [Column("registered_office_rta", Order = 158, TypeName = "varchar(50)")]
       public string? registered_office_rta { get; set; }

       [Column("corporate_office_rta", Order = 159, TypeName = "varchar(50)")]
       public string? corporate_office_rta { get; set; }

       [Column("cin_no_rta", Order = 160, TypeName = "varchar(50)")]
       public string? cin_no_rta { get; set; }

       [Column("pan_no_rta", Order = 161, TypeName = "varchar(50)")]
       public string? pan_no_rta { get; set; }

       [Column("isin_rta", Order = 162, TypeName = "varchar(50)")]
       public string? isin_rta { get; set; }

       [Column("ph_nos_rta", Order = 163, TypeName = "varchar(50)")]
       public string? ph_nos_rta { get; set; }

       [Column("member_in_exchange_rta", Order = 164, TypeName = "varchar(50)")]
       public string? member_in_exchange_rta { get; set; }

       [Column("depository_participant_rta", Order = 165, TypeName = "varchar(50)")]
       public string? depository_participant_rta { get; set; }

       [Column("category_detail_rta", Order = 166, TypeName = "varchar(50)")]
       public string? category_detail_rta { get; set; }

       [Column("from_date", Order = 167, TypeName = "datetime")]
       public DateTime? from_date { get; set; }

       [Column("upto_date", Order = 168, TypeName = "datetime")]
       public DateTime? upto_date { get; set; }

       [Column("rep_date", Order = 169, TypeName = "datetime")]
