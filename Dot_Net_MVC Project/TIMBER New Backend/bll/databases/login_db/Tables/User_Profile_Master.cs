...
namespace DB.Login.Tables
{
    ...
    public class User_Profile_Master
    {
          public User_Profile_Master()
        {
            ...
            this.User_Registration_Historys= new HashSet<User_Registration_History>();
        }
        ...
        [JsonIgnore]
        public virtual ICollection<User_Registration_History> User_Registration_Historys { get; set; }
    }
}