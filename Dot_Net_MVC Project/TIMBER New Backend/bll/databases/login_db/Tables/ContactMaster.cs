...
namespace DB.Login.Tables
{
    public class ContactMaster
    {
        ...
        [Column("remark", Order = 15, TypeName = "text")]
        public string? remark { get; set; }

        [Column("sent_on", Order = 16, TypeName = "datetime")]
        public DateTime? sent_on { get; set; }

        [Column("seen_by", Order = 17, TypeName = "text")]
        public string? seen_by { get; set; }

        [Column("seen_by_id", Order = 18, TypeName = "bigint")]
        public long? seen_by_id { get; set; }
    }
}
