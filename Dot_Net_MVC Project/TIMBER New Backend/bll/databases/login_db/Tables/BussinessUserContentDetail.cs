...
{
    public class BussinessUserContentDetail
    {
        [Key]
        ...
        [Column("drop_value", Order = 18, TypeName = "text")]
        public string? drop_value { get; set; }
        ...
        public DateTime? updated_at { get; set; } = DateTime.Now;  // drop_value // used order no. 18
    } 
}
