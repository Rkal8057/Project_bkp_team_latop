...
namespace DB.Login
{
    public partial class loginDBContext : DbContext
    {
        ...
        public virtual DbSet<WarrantyExtendedItemTran> WarrantyExtendedItemTran { get; set; }
        public virtual DbSet<WarrantyExtendedItemWarrantyTrans> WarrantyExtendedItemWarrantyTrans { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
           ...
           /* modelBuilder.Entity<PartyAddressTransMaster>(entity =>
            ...
            modelBuilder.Entity<User_Detail>(entity =>
            {
             ...
             modelBuilder.Entity<User_Registration_History>(entity =>
            {
                entity.HasIndex(e => e.user_code).IsUnique();
                entity.HasOne(e => e.User_Profile_Masters)
                    .WithMany(e => e.User_Registration_Historys).HasForeignKey(e => e.user_profile_id);
            });
