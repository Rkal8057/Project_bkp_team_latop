...
{
    public class NewBusinessUserDetailReq
    {
        ...
        public List<NewBusinessSectionDataByIDType> NewBusinessSectionDataByIDType { get; set; }

    }

    public class NewBusinessSectionDataByIDType
    {
