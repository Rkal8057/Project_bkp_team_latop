...
{
   [Table ("tr_name_mis_match_detail_trx_tmp")] 
       
   public class Tr_Name_Mis_Match_Detail_Trx_Tmp
   {
       ...
       [Column("reason_table_id", Order = 5, TypeName = "bigint(10)")]
       public long? reason_table_id { get; set; }

       [Column("reason_detail", Order = 6, TypeName = "varchar(50)")]
       public string? reason_detail { get; set; }

       [Column("reason_code", Order = 7, TypeName = "varchar(60)")]
       public string? reason_code { get; set; }

       [Column("selected_yn", Order = 8, TypeName = "varchar(3)")]
