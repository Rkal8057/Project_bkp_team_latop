...
namespace DB.RTAComp.Tables
{
   ...
   public class Partymaster
   {
       ...
       [Column("group_code", Order = 6, TypeName = "bigint(10)")]
       public long? group_code { get; set; }

       [Column("group_name", Order = 7, TypeName = "varchar(50)")]
       public string? group_name { get; set; }

       [Column("gmain_code", Order = 8, TypeName = "bigint(10)")]
       ...
       [Column("bill_dis_per", Order = 52, TypeName = "bigint(10)")]
       public long? bill_dis_per { get; set; }

       [Column("gst_tax_rate", Order = 53, TypeName = "bigint(10)")]
       public long? gst_tax_rate { get; set; }

       [Column("other13", Order = 54, TypeName = "bigint(10)")]
       public long? other13 { get; set; }

       [Column("other14", Order = 55, TypeName = "bigint(10)")]
       public long? other14 { get; set; }

       [Column("other15", Order = 56, TypeName = "bigint(10)")]
       public long? other15 { get; set; }

       [Column("pay_term_days", Order = 57, TypeName = "bigint(10)")]
       public long? pay_term_days { get; set; }

       [Column("bill_dis_per_2", Order = 58, TypeName = "double(18,3)")]
       public long? bill_dis_per_2 { get; set; }

       [Column("addhar_no", Order = 59, TypeName = "varchar(100)")]
