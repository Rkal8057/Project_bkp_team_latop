...
namespace DB.RTAComp.Tables
{
   ...
   public class Tr_Change_Add
   {
       ...
       [Column("t_ad1", Order = 77, TypeName = "varchar(250)")]
       public string? t_ad1 { get; set; }

       [Column("t_ad2", Order = 78, TypeName = "varchar(250)")]
       public string? t_ad2 { get; set; }

       [Column("t_city", Order = 79, TypeName = "varchar(250)")]
       public string? t_city { get; set; }

       [Column("t_state", Order = 80, TypeName = "varchar(250)")]
       public string? t_state { get; set; }

       [Column("t_pincode", Order = 81, TypeName = "varchar(250)")]
       public string? t_pincode { get; set; }

       [Column("t_country_name", Order = 82, TypeName = "varchar(250)")]
       public string? t_country_name { get; set; }

       [Column("p_ad1", Order = 83, TypeName = "varchar(250)")]
       public string? p_ad1 { get; set; }

       [Column("p_ad2", Order = 84, TypeName = "varchar(250)")]
       public string? p_ad2 { get; set; }

       [Column("p_city", Order = 85, TypeName = "varchar(250)")]
       public string? p_city { get; set; }

       [Column("p_state", Order = 86, TypeName = "varchar(250)")]
       public string? p_state { get; set; }

       [Column("p_pincode", Order = 87, TypeName = "varchar(250)")]
       public string? p_pincode { get; set; }

       [Column("p_country_name", Order = 88, TypeName = "varchar(250)")]
       public string? p_country_name { get; set; }

       [Column("multiple_folio", Order = 89, TypeName = "varchar(3)")]
       public string? multiple_folio { get; set; }

       [Column("rr_flag_name", Order = 90, TypeName = "varchar(50)")]
       public string? rr_flag_name { get; set; }

       [Column("trx_remark", Order = 91, TypeName = "varchar(50)")]
       public string? trx_remark { get; set; }

       [Column("reject_code_grid", Order = 92, TypeName = "varchar(50)")]
       public string? reject_code_grid { get; set; }

       [Column("reject_remark_grid", Order = 93, TypeName = "varchar(50)")]
       public string? reject_remark_grid { get; set; }

       [Column("share_accept_yn_13_05_2022_t45_16_45_51", Order = 94, TypeName = "varchar(3)")]
       public string? share_accept_yn_13_05_2022_t45_16_45_51 { get; set; }

       [Column("old_distno_new", Order = 95, TypeName = "varchar(50)")]
