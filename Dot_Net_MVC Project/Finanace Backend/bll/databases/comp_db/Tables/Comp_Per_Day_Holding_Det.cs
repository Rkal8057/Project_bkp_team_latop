...
{
   [Table ("comp_per_day_holding_det")] 
       
   public class Comp_Per_Day_Holding_Det
   {
       ...
       [Column("import_day_name", Order = 7, TypeName = "varchar(50)")]
       public string? import_day_name { get; set; }

       [Column("file_exchange_name", Order = 8, TypeName = "varchar(50)")]
       public string? file_exchange_name { get; set; }

       [Column("isin_no", Order = 9, TypeName = "varchar(50)")]
       public string? isin_no { get; set; }

       [Column("isin_comp_name", Order = 10, TypeName = "varchar(50)")]
       ...
       [Column("exch_cls_qty_remark_cdsl", Order = 31, TypeName = "varchar(50)")]
       ...
       [Column("exch_cls_qty_remark_nsdl", Order = 33, TypeName = "varchar(50)")]
       ...
       [Column("user_name", Order = 37, TypeName = "varchar(50)")]
       public string? user_name { get; set; }

       [Column("computer_id", Order = 38, TypeName = "varchar(50)")]
