...
namespace DB.RTAComp.Tables
{
   ...
   public class Texla1_Log
   {
       ...
       [Column("comp_sno", Order = 120, TypeName = "float")]
       public long? comp_sno { get; set; }

       [Column("comp_isin", Order = 121, TypeName = "varchar(50)")]
       public string? comp_isin { get; set; }

       [Column("comp_name", Order = 122, TypeName = "varchar(50)")]
       public string? comp_name { get; set; }

       [Column("comp_name_short", Order = 123, TypeName = "varchar(50)")]
       public string? comp_name_short { get; set; }

       [Column("pan1_addhar_linked_yn", Order = 124, TypeName = "varchar(3)")]
       public string? pan1_addhar_linked_yn { get; set; }

       [Column("pan2_addhar_linked_yn", Order = 125, TypeName = "varchar(3)")]
       public string? pan2_addhar_linked_yn { get; set; }

       [Column("pan3_addhar_linked_yn", Order = 126, TypeName = "varchar(3)")]
       public string? pan3_addhar_linked_yn { get; set; }

       [Column("share_price", Order = 127, TypeName = "float")]
       public long? share_price { get; set; }

       [Column("share_type", Order = 128, TypeName = "varchar(50)")]
