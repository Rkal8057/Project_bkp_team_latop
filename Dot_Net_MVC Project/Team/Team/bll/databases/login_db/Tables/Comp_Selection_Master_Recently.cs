...
{
public class Comp_Selection_Master_Recently
   {
       ...
       [Column("c_sign_image_path_auto_yn", Order = 94, TypeName = "varchar(3)")]
       public string? c_sign_image_path_auto_yn { get; set; }

       [Column("cert_convert_to_numrice_yn", Order = 95, TypeName = "varchar(3)")]
       public string? cert_convert_to_numrice_yn { get; set; }

       [Column("folio_convert_to_numrice_yn", Order = 96, TypeName = "varchar(3)")]
       public string? folio_convert_to_numrice_yn { get; set; }

       [Column("listing_on_bse_nse", Order = 97, TypeName = "text")]
       public string? listing_on_bse_nse { get; set; }

       [Column("company_agreement_type", Order = 98, TypeName = "text")]
       public string? company_agreement_type { get; set; }

       [Column("start_date_agree", Order = 99, TypeName = "datetime")]
       public DateTime? start_date_agree { get; set; }

       [Column("end_date_agree", Order = 100, TypeName = "datetime")]
       public DateTime? end_date_agree { get; set; }

       [Column("company_status", Order = 101, TypeName = "text")]
       public string? company_status { get; set; }

       [Column("c_class_of_security", Order = 102, TypeName = "text")]
       public string? c_class_of_security { get; set; }

       [Column("c_name_of_scrip", Order = 103, TypeName = "text")]
       public string? c_name_of_scrip { get; set; }

       [Column("c_scrip_code", Order = 104, TypeName = "text")]
