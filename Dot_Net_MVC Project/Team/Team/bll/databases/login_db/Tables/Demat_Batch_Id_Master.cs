...
public class Demat_Batch_Id_Master
   {
       ...
       [Column("batch_no", Order = 5, TypeName = "float")]
       public long? batch_no { get; set; }

       [Column("batch_no_text", Order = 6, TypeName = "varchar(140)")]
       public string? batch_no_text { get; set; }

       [Column("branch_code", Order = 7, TypeName = "varchar(140)")]
       public string? branch_code { get; set; }

       [Column("rta_id_sr_bp_id", Order = 8, TypeName = "varchar(50)")]
       public string? rta_id_sr_bp_id { get; set; }

       [Column("operator_id", Order = 9, TypeName = "varchar(50)")]
       public string? operator_id { get; set; }

       [Column("total_no_of_records", Order = 10, TypeName = "varchar(50)")]
       ...
       [Column("trx_flag", Order = 13, TypeName = "varchar(100)")]
       public string? trx_flag { get; set; }

       [Column("file_extension_text", Order = 14, TypeName = "varchar(100)")]
       public string? file_extension_text { get; set; }

       [Column("file_extension_no", Order = 15, TypeName = "float")]
       public long? file_extension_no { get; set; }
