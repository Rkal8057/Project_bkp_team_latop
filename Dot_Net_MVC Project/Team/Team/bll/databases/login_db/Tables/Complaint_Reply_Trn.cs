...
{
public class Complaint_Reply_Trn
   {
       ...
       [Column("cplt_rec_reply_to", Order = 8, TypeName = "text")]
       public string? cplt_rec_reply_to { get; set; }

       [Column("cplt_rec_naturn_of_complaint", Order = 9, TypeName = "text")]
       public string? cplt_rec_naturn_of_complaint { get; set; }

       [Column("cplt_rec_nature_detail", Order = 10, TypeName = "text")]
       public string? cplt_rec_nature_detail { get; set; }

       [Column("cplt_rec_maker_remark", Order = 11, TypeName = "text")]
       public string? cplt_rec_maker_remark { get; set; }

       [Column("cplt_rec_verify_by_user", Order = 12, TypeName = "text")]
       public string? cplt_rec_verify_by_user { get; set; }

       [Column("cplt_rec_verify_datetime_auto", Order = 13, TypeName = "datetime")]
       public DateTime? cplt_rec_verify_datetime_auto { get; set; }

       [Column("cplt_rec_reject_yn", Order = 14, TypeName = "varchar(3)")]
       public string? cplt_rec_reject_yn { get; set; }

       [Column("cplt_rec_reject_remark", Order = 15, TypeName = "text")]
       public string? cplt_rec_reject_remark { get; set; }

       [Column("cplt_rec_reply_date", Order = 16, TypeName = "datetime")]
       public DateTime? cplt_rec_reply_date { get; set; }

       [Column("cplt_rec_action_type", Order = 17, TypeName = "text")]
       public string? cplt_rec_action_type { get; set; }

       [Column("cplt_rec_action_remark", Order = 18, TypeName = "text")]
