...
{
public class Reco_Row_File_Cdsl
   {
       ...
       [Column("reco_online_isin_no", Order = 6, TypeName = "text")]
       public string? reco_online_isin_no { get; set; }

       [Column("reco_online_isin_company", Order = 7, TypeName = "text")]
       public string? reco_online_isin_company { get; set; }

       [Column("reco_record_date", Order = 8, TypeName = "datetime")]
       public DateTime? reco_record_date { get; set; }

       [Column("reco_record_date_text", Order = 9, TypeName = "varchar(20)")]
