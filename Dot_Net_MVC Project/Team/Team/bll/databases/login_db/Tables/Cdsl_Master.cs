...
public class Cdsl_Master
   {
       ...
       [Column("ad1", Order = 64, TypeName = "text")]
       public string? ad1 { get; set; }

       [Column("ad2", Order = 65, TypeName = "text")]
       public string? ad2 { get; set; }

       [Column("ad3", Order = 66, TypeName = "text")]
       ...
       [Column("pad1", Order = 71, TypeName = "text")]
       public string? pad1 { get; set; }

       [Column("pad2", Order = 72, TypeName = "text")]
       public string? pad2 { get; set; }

       [Column("pad3", Order = 73, TypeName = "text")]
