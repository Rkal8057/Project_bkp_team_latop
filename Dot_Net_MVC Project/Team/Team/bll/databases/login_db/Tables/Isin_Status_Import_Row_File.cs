...
{
public class Isin_Status_Import_Row_File
   {
       ...
       [Column("isin_status_record_date", Order = 6, TypeName = "datetime")]
       public DateTime? isin_status_record_date { get; set; }

       [Column("isin_status_record_date_text", Order = 7, TypeName = "varchar(50)")]
