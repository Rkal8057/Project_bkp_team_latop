...
public class Reco_Import_02
   {
       ...
       [Column("line_no", Order = 10, TypeName = "varchar(7)")]
       public string? line_no { get; set; }

       [Column("isin_no", Order = 11, TypeName = "varchar(12)")]
       public string? isin_no { get; set; }

       [Column("isin_comp_short", Order = 12, TypeName = "varchar(140)")]
       public string? isin_comp_short { get; set; }

       [Column("isin_comp_name", Order = 13, TypeName = "varchar(140)")]
       public string? isin_comp_name { get; set; }

       [Column("flag_for_decimal_isin", Order = 14, TypeName = "varchar(18)")]
       public string? flag_for_decimal_isin { get; set; }

       [Column("nsdl_free_positions", Order = 15, TypeName = "varchar(18)")]
       public string? nsdl_free_positions { get; set; }

       [Column("nsdl_lock_positions", Order = 16, TypeName = "varchar(18)")]
       public string? nsdl_lock_positions { get; set; }

       [Column("nsdl_unlock_balance", Order = 17, TypeName = "varchar(18)")]
       public string? nsdl_unlock_balance { get; set; }

       [Column("nsdl_lock_balance", Order = 18, TypeName = "varchar(18)")]
       public string? nsdl_lock_balance { get; set; }

       [Column("pending_demat_balance", Order = 19, TypeName = "varchar(18)")]
       public string? pending_demat_balance { get; set; }

       [Column("pending_remat_free_balance", Order = 20, TypeName = "varchar(18)")]
       public string? pending_remat_free_balance { get; set; }

       [Column("pending_remat_lock_balance", Order = 21, TypeName = "varchar(18)")]
       public string? pending_remat_lock_balance { get; set; }

       [Column("nsdl_delivery_transit_balance", Order = 22, TypeName = "varchar(18)")]
       public string? nsdl_delivery_transit_balance { get; set; }

       [Column("nsdl_receipt_transit_balance", Order = 23, TypeName = "varchar(18)")]
       public string? nsdl_receipt_transit_balance { get; set; }

       [Column("filler", Order = 24, TypeName = "varchar(162)")]
       public string? filler { get; set; }

       [Column("security_type", Order = 25, TypeName = "varchar(2)")]
       public string? security_type { get; set; }

       [Column("filler2", Order = 26, TypeName = "varchar(13)")]
       public string? filler2 { get; set; }

       [Column("user_name", Order = 27, TypeName = "text")]
       public string? user_name { get; set; }

       [Column("computer_id", Order = 28, TypeName = "text")]
