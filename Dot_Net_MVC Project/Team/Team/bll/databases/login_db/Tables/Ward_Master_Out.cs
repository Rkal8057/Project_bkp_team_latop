...
public class Ward_Master_Out
   {
       ...
       [Column("req_comp", Order = 36, TypeName = "text")]
       public string? req_comp { get; set; }

       [Column("req_comp_name", Order = 37, TypeName = "text")]
       public string? req_comp_name { get; set; }

       [Column("req_comp_code", Order = 38, TypeName = "text")]
       public string? req_comp_code { get; set; }

       [Column("req_comp_id", Order = 39, TypeName = "text")]
       public string? req_comp_id { get; set; }

       [Column("req_rec_id", Order = 40, TypeName = "float")]
       public long? req_rec_id { get; set; }

       [Column("req_rec_date", Order = 41, TypeName = "datetime")]
       public DateTime? req_rec_date { get; set; }

       [Column("req_rec_status", Order = 42, TypeName = "varchar(100)")]
       public string? req_rec_status { get; set; }

       [Column("req_rec_reject_yn", Order = 43, TypeName = "varchar(1)")]
       public string? req_rec_reject_yn { get; set; }

       [Column("imported_iw_atuo_id", Order = 44, TypeName = "text")]
       public string? imported_iw_atuo_id { get; set; }

       [Column("cplt_rec_id", Order = 45, TypeName = "text")]
       public string? cplt_rec_id { get; set; }

       [Column("despatch_remark", Order = 46, TypeName = "text")]
       public string? despatch_remark { get; set; }

       [Column("entry_date_4_despatch", Order = 47, TypeName = "datetime")]
       public DateTime? entry_date_4_despatch { get; set; }

       [Column("un_delivered_yn", Order = 48, TypeName = "text")]
       public string? un_delivered_yn { get; set; }

       [Column("un_delivered_date", Order = 49, TypeName = "datetime")]
       public DateTime? un_delivered_date { get; set; }

       [Column("un_delivered_remark", Order = 50, TypeName = "text")]
       public string? un_delivered_remark { get; set; }

       [Column("exchange_name", Order = 51, TypeName = "varchar(50)")]
       public string? exchange_name { get; set; }

       [Column("courier_name", Order = 52, TypeName = "text")]
       public string? courier_name { get; set; }

       [Column("folio_no", Order = 53, TypeName = "varchar(20)")]
