...
{
public class Comp_Selection_Master
   {
       ...
       [Column("c_paid_up_capital", Order = 6, TypeName = "float")]
       ...
       [Column("c_created_by", Order = 56, TypeName = "varchar(100)")]
       ...
       [Column("c_comp_auto_id", Order = 75, TypeName = "bigint(10)")]
       public long? c_comp_auto_id { get; set; }

       [Column("c_maintain_type", Order = 76, TypeName = "varchar(250)")]
       public string? c_maintain_type { get; set; }

       [Column("c_data_tyep_description", Order = 77, TypeName = "varchar(50)")]
       public string? c_data_tyep_description { get; set; }

       [Column("c_isin_type", Order = 78, TypeName = "varchar(50)")]
       public string? c_isin_type { get; set; }

       [Column("c_phy_demat_both", Order = 79, TypeName = "varchar(50)")]
       public string? c_phy_demat_both { get; set; }

       [Column("c_pincode", Order = 80, TypeName = "varchar(10)")]
       public string? c_pincode { get; set; }

       [Column("c_group_name", Order = 81, TypeName = "varchar(100)")]
       public string? c_group_name { get; set; }

       [Column("c_issuer_code", Order = 82, TypeName = "varchar(100)")]
       public string? c_issuer_code { get; set; }

       [Column("c_phy_conn_yn", Order = 83, TypeName = "varchar(3)")]
       public string? c_phy_conn_yn { get; set; }

       [Column("c_rep_weekly_email_yn", Order = 84, TypeName = "varchar(3)")]
       public string? c_rep_weekly_email_yn { get; set; }

       [Column("c_company_old_code", Order = 85, TypeName = "varchar(100)")]
       public string? c_company_old_code { get; set; }

       [Column("c_tot_equity", Order = 86, TypeName = "double(18,3)")]
       public long? c_tot_equity { get; set; }

       [Column("cin_bcin_no", Order = 87, TypeName = "varchar(50)")]
       public string? cin_bcin_no { get; set; }

       [Column("folio_no_auto_yn", Order = 88, TypeName = "varchar(1)")]
       public string? folio_no_auto_yn { get; set; }

       [Column("temp_comp_id", Order = 89, TypeName = "varchar(50)")]
       public string? temp_comp_id { get; set; }

       [Column("c_tot_equity_fully", Order = 90, TypeName = "double(18,3)")]
       public long? c_tot_equity_fully { get; set; }

       [Column("c_tot_equity_partly", Order = 91, TypeName = "double(18,3)")]
       public long? c_tot_equity_partly { get; set; }

       [Column("c_share_face_value_partly", Order = 92, TypeName = "double(18,3)")]
       public long? c_share_face_value_partly { get; set; }

       [Column("c_sign_image_path_auto_yn", Order = 93, TypeName = "varchar(3)")]
       public string? c_sign_image_path_auto_yn { get; set; }

       [Column("c_scrip_code", Order = 94, TypeName = "text")]
       public string? c_scrip_code { get; set; }

       [Column("c_name_of_scrip", Order = 95, TypeName = "text")]
       public string? c_name_of_scrip { get; set; }

       [Column("c_class_of_security", Order = 96, TypeName = "text")]
       public string? c_class_of_security { get; set; }

       [Column("folio_convert_to_numrice_yn", Order = 97, TypeName = "text")]
       public string? folio_convert_to_numrice_yn { get; set; }

       [Column("cert_convert_to_numrice_yn", Order = 98, TypeName = "text")]
       public string? cert_convert_to_numrice_yn { get; set; }

       [Column("test_coloum", Order = 99, TypeName = "varchar(3)")]
       public string? test_coloum { get; set; }

       [Column("listing_on_bse_nse", Order = 100, TypeName = "text")]
       public string? listing_on_bse_nse { get; set; }

       [Column("company_agreement_type", Order = 101, TypeName = "text")]
       public string? company_agreement_type { get; set; }

       [Column("start_date_agree", Order = 102, TypeName = "datetime")]
       public DateTime? start_date_agree { get; set; }

       [Column("end_date_agree", Order = 103, TypeName = "datetime")]
       public DateTime? end_date_agree { get; set; }

       [Column("company_status", Order = 104, TypeName = "text")]
       public string? company_status { get; set; }

       [Column("folio_lenght", Order = 105, TypeName = "varchar(16)")]
       public string? folio_lenght { get; set; }

       [Column("listing_on_bse_yn", Order = 106, TypeName = "varchar(3)")]
       public string? listing_on_bse_yn { get; set; }

       [Column("listing_on_nse_yn", Order = 107, TypeName = "varchar(3)")]
       public string? listing_on_nse_yn { get; set; }

       [Column("listing_on_mse_yn", Order = 108, TypeName = "varchar(3)")]
       public string? listing_on_mse_yn { get; set; }
       
       [JsonIgnore]
       public virtual ICollection<Comp_DB> Comp_DBs { get; set; }
