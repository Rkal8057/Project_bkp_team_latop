...
{
public class Log_Comp_Master
   {
       [Key, Column("id", Order = 1, TypeName = " bigint(10) auto_increment"), Required]
       public long? id { get; set; }
       
       [Column("c_comp_no", Order = 2, TypeName = "float")]
       public long? c_comp_no { get; set; }

       [Column("c_id", Order = 3, TypeName = "varchar(100)")]
       public string? c_id { get; set; }

       [Column("c_name", Order = 4, TypeName = "varchar(100)")]
       public string? c_name { get; set; }

       [Column("c_short_name", Order = 5, TypeName = "varchar(100)")]
       ...
       [Column("c_folio_no_auto_yn", Order = 35, TypeName = "varchar(1)")]
       public string? c_folio_no_auto_yn { get; set; }

       [Column("c_comp_no_id", Order = 36, TypeName = "bigint(10)")]
       public long? c_comp_no_id { get; set; }

       [Column("c_company_type", Order = 37, TypeName = "varchar(50)")]
       public string? c_company_type { get; set; }

       [Column("c_cin_bcin_no", Order = 38, TypeName = "varchar(50)")]
       public string? c_cin_bcin_no { get; set; }

       [Column("c_company_code", Order = 39, TypeName = "varchar(4)")]
       public string? c_company_code { get; set; }

       [Column("c_company_sub_code", Order = 40, TypeName = "varchar(4)")]
       public string? c_company_sub_code { get; set; }

       [Column("c_database_type", Order = 41, TypeName = "varchar(50)")]
       public string? c_database_type { get; set; }

       [Column("c_more_isin_yn", Order = 42, TypeName = "varchar(3)")]
       public string? c_more_isin_yn { get; set; }

       [Column("c_master_comp_isin", Order = 43, TypeName = "varchar(12)")]
       public string? c_master_comp_isin { get; set; }

       [Column("c_master_comp_code", Order = 44, TypeName = "double(18,3)")]
       public long? c_master_comp_code { get; set; }

       [Column("c_master_comp_name", Order = 45, TypeName = "text")]
       public string? c_master_comp_name { get; set; }

       [Column("c_nsdl_conn_yn", Order = 46, TypeName = "varchar(3)")]
       public string? c_nsdl_conn_yn { get; set; }

       [Column("c_cdsl_conn_yn", Order = 47, TypeName = "varchar(3)")]
       public string? c_cdsl_conn_yn { get; set; }

       [Column("c_phy_shares_yn", Order = 48, TypeName = "varchar(3)")]
       public string? c_phy_shares_yn { get; set; }

       [Column("c_tan", Order = 49, TypeName = "varchar(10)")]
       public string? c_tan { get; set; }

       [Column("c_isin_detail", Order = 50, TypeName = "text")]
       public string? c_isin_detail { get; set; }

       [Column("c_pay_term_days", Order = 51, TypeName = "double(18,3)")]
       public long? c_pay_term_days { get; set; }

       [Column("c_pay_term_detail", Order = 52, TypeName = "text")]
       public string? c_pay_term_detail { get; set; }

       [Column("c_other_detail", Order = 53, TypeName = "text")]
       public string? c_other_detail { get; set; }

       [Column("c_d_o_activate", Order = 54, TypeName = "datetime")]
       public DateTime? c_d_o_activate { get; set; }

       [Column("c_d_o_apply", Order = 55, TypeName = "datetime")]
       public DateTime? c_d_o_apply { get; set; }

       [Column("c_d_o_creation", Order = 56, TypeName = "datetime")]
       public DateTime? c_d_o_creation { get; set; }

       [Column("c_created_by", Order = 57, TypeName = "text")]
       public string? c_created_by { get; set; }

       [Column("c_d_o_updation", Order = 58, TypeName = "datetime")]
       public DateTime? c_d_o_updation { get; set; }

       [Column("c_updated_by", Order = 59, TypeName = "text")]
       public string? c_updated_by { get; set; }

       [Column("c_contact_person2", Order = 60, TypeName = "varchar(100)")]
       public string? c_contact_person2 { get; set; }

       [Column("c_contact_ph", Order = 61, TypeName = "varchar(100)")]
       public string? c_contact_ph { get; set; }

       [Column("c_contact_ph2", Order = 62, TypeName = "varchar(100)")]
       public string? c_contact_ph2 { get; set; }

       [Column("c_contact_p_email", Order = 63, TypeName = "varchar(10)")]
       public string? c_contact_p_email { get; set; }

       [Column("c_contact_p_email2", Order = 64, TypeName = "varchar(100)")]
       public string? c_contact_p_email2 { get; set; }

       [Column("c_add1_2", Order = 65, TypeName = "text")]
       public string? c_add1_2 { get; set; }

       [Column("c_add2_2", Order = 66, TypeName = "text")]
       public string? c_add2_2 { get; set; }

       [Column("c_add3_2", Order = 67, TypeName = "text")]
       public string? c_add3_2 { get; set; }

       [Column("c_city2", Order = 68, TypeName = "varchar(100)")]
       public string? c_city2 { get; set; }

       [Column("c_pincode_2", Order = 69, TypeName = "varchar(10)")]
       public string? c_pincode_2 { get; set; }

       [Column("c_state2", Order = 70, TypeName = "varchar(100)")]
       public string? c_state2 { get; set; }

       [Column("c_state_code2", Order = 71, TypeName = "varchar(10)")]
       public string? c_state_code2 { get; set; }

       [Column("c_list_to_email_yn", Order = 72, TypeName = "text")]
       public string? c_list_to_email_yn { get; set; }

       [Column("c_rep_top10_email_yn", Order = 73, TypeName = "text")]
       public string? c_rep_top10_email_yn { get; set; }

       [Column("c_other_rpt_email_yn", Order = 74, TypeName = "text")]
       public string? c_other_rpt_email_yn { get; set; }

       [Column("c_source_email_yn", Order = 75, TypeName = "text")]
       public string? c_source_email_yn { get; set; }

       [Column("used_on_date_time", Order = 76, TypeName = "datetime")]
