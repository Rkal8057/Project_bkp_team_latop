...
public class Cdsl_Master_02
   {
       ...
       [Column("ad1", Order = 45, TypeName = "text")]
       public string? ad1 { get; set; }

       [Column("ad2", Order = 46, TypeName = "text")]
       public string? ad2 { get; set; }

       [Column("ad3", Order = 47, TypeName = "text")]
       ...
       [Column("pad1", Order = 52, TypeName = "text")]
       public string? pad1 { get; set; }

       [Column("pad2", Order = 53, TypeName = "text")]
       public string? pad2 { get; set; }

       [Column("pad3", Order = 54, TypeName = "text")]
