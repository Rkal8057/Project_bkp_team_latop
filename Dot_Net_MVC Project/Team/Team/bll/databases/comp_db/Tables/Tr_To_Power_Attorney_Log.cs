...
{
   [Table ("tr_to_power_attorney_log")] 
       
   public class Tr_To_Power_Attorney_Log
   {
       ...
       [Column("share_accept_yn_13_05_2022_t45_16_45_51", Order = 83, TypeName = "varchar(3)")]
       ...
       [Column("p_adhaar_no", Order = 97, TypeName = "varchar(30)")]
       public string? p_adhaar_no { get; set; }

       [Column("p_voter_id", Order = 98, TypeName = "varchar(30)")]
       public string? p_voter_id { get; set; }

       [Column("p_dl_no", Order = 99, TypeName = "varchar(30)")]
       public string? p_dl_no { get; set; }

       [Column("p_passport_no", Order = 100, TypeName = "varchar(30)")]
       public string? p_passport_no { get; set; }

       [Column("t_adhaar_no", Order = 101, TypeName = "varchar(30)")]
       public string? t_adhaar_no { get; set; }

       [Column("t_voter_id", Order = 102, TypeName = "varchar(30)")]
       public string? t_voter_id { get; set; }

       [Column("t_dl_no", Order = 103, TypeName = "varchar(30)")]
       public string? t_dl_no { get; set; }

       [Column("t_passport_no", Order = 104, TypeName = "varchar(30)")]
       public string? t_passport_no { get; set; }

       [Column("comp_sno", Order = 105, TypeName = "float")]
       public long? comp_sno { get; set; }

       [Column("comp_isin", Order = 106, TypeName = "varchar(50)")]
       public string? comp_isin { get; set; }

       [Column("comp_name", Order = 107, TypeName = "varchar(50)")]
       public string? comp_name { get; set; }

       [Column("comp_name_short", Order = 108, TypeName = "varchar(50)")]
