...
{
   [Table ("tr_to_iepf_log")] 
       
   public class Tr_To_Iepf_Log
   {
       ...
       [Column("old_distno_new", Order = 17, TypeName = "varchar(50)")]
       public string? old_distno_new { get; set; }

       [Column("certno", Order = 18, TypeName = "varchar(250)")]
       public string? certno { get; set; }

       [Column("pr_certno", Order = 19, TypeName = "varchar(1000)")]
       public string? pr_certno { get; set; }

       [Column("old_certno", Order = 20, TypeName = "varchar(50)")]
