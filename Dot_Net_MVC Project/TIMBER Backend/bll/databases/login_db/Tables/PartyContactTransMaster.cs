...
namespace DB.Login.Tables
{
    public class PartyContactTransMaster
    {
        ...
        [Column("party_contact_mobile", Order = 2, TypeName = "bigint")]
        public long? party_contact_mobile { get; set; }

        [Column("party_contact_whatsapp_mobile", Order = 3, TypeName = "bigint")]
        ...
        [Column("party_landline_no", Order = 6, TypeName = "bigint")]
        public long? party_landline_no { get; set; }
