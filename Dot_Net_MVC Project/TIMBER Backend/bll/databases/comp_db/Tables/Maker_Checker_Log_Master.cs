...
{
   [Table ("maker_checker_log_master")] 
       
   public class Maker_Checker_Log_Master
   {
       ...
       [Column("maker_checker_log_id_status", Order = 3, TypeName = "varchar(50)")]
       ...
       [Column("comp_isin", Order = 7, TypeName = "varchar(50)")]
       public string? comp_isin { get; set; }

       [Column("comp_name", Order = 8, TypeName = "varchar(50)")]
       public string? comp_name { get; set; }

       [Column("comp_name_short", Order = 9, TypeName = "varchar(50)")]
       public string? comp_name_short { get; set; }

       [Column("trfno", Order = 10, TypeName = "bigint(10)")]
       public long? trfno { get; set; }

       [Column("trfdate", Order = 11, TypeName = "datetime")]
       ...
       [Column("maker_remark", Order = 15, TypeName = "varchar(50)")]
       public string? maker_remark { get; set; }

       [Column("maker_status", Order = 16, TypeName = "varchar(50)")]
       ...
       [Column("checker_remark", Order = 20, TypeName = "varchar(50)")]
       public string? checker_remark { get; set; }

       [Column("checker_status", Order = 21, TypeName = "varchar(50)")]
       ...
       [Column("current_status", Order = 23, TypeName = "varchar(50)")]
