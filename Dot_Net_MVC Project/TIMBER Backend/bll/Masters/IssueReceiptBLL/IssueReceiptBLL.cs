    ...
    public class IssueReceiptMasterBLL
    {
        ...
        public IssueReceiptResp GetIssueReceiptMaster()
        {
            IssueReceiptResp data = new IssueReceiptResp()
            {
                ...
                IssueReceiptMasterDetailData = DB.IssueReceiptMaster.Where(e=>e.delete_at == 0).ToList()
            };
            return data;
        }


        public IssueReceiptResp GetIssueReceiptMasterByLastRecords(long? challanId)
        {
        ...
        public IssueReceiptResp CheckChallanNumber(string challanNumber)
        {
            IssueReceiptResp data = new IssueReceiptResp()
            {
                status = false,
                ...
                // .Include( e=> e.Challan_Single_Item_Master)
                .Where(e => e.challanno == challanNumber).FirstOrDefault(),
            };
            return data;
        }
