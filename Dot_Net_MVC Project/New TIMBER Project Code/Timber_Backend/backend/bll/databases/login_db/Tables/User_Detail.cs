...
namespace DB.Login.Tables
{
    public class User_Detail
    {
        ...
        [Column("user_mobile", Order = 13, TypeName = "varchar(20)")]
        ...
        [Column("user_email_verified_yn", Order = 26, TypeName = "varchar(10)")]
        public string? user_email_verified_yn { get; set; }

        [Column("user_phn_verified_yn", Order = 27, TypeName = "varchar(10)")]
        public string? user_phn_verified_yn { get; set; }

        [Column("user_pan_verified_yn", Order = 28, TypeName = "varchar(10)")]
        public string? user_pan_verified_yn { get; set; }

        [Column("user_creation_mode", Order = 29, TypeName = "varchar(10)")]
        public string? user_creation_mode { get; set; }

        [Column("user_created_by_name", Order = 30, TypeName = "varchar(100)")]
        public string? user_created_by_name { get; set; }

        [Column("user_created_by_id", Order = 31, TypeName = "bigint(10)")]
        public long? user_created_by_id { get; set; } 
        
        [Column("sponsored_user_id", Order = 32, TypeName = "bigint(10)")]
        public long? sponsored_user_id { get; set; }

        [Column("sponsored_user_mobile", Order = 33, TypeName = "varchar(20)")]
        public string? sponsored_user_mobile { get; set; }

        [Column("left_side_user_id", Order = 34, TypeName = "bigint(10)")]
        public long? left_side_user_id { get; set; }        
        
        [Column("right_side_user_id", Order = 35, TypeName = "bigint(10)")]
        public long? right_side_user_id { get; set; }

        [Column("left_side_user_mobile", Order = 36, TypeName = "varchar(20)")]
        public string? left_side_user_mobile { get; set; }        
        
        [Column("right_side_user_mobile", Order = 37, TypeName = "varchar(20)")]
        public string? right_side_user_mobile { get; set; }

        [Column("under_user_id", Order = 38, TypeName = "bigint(10)")]
        public long? under_user_id { get; set; }

        [Column("under_user_mobile", Order = 39, TypeName = "varchar(20)")]
        public string? under_user_mobile { get; set; }

        [Column("sponsored_by_user_name", Order = 40, TypeName = "varchar(50)")]
        public string? sponsored_by_user_name { get; set; }
