...
namespace DB.Login.Tables
{
    public class PartyMaster
    {
        ...
        [Column("agreement_yn", Order = 31, TypeName = "text")]
        public string? agreement_yn { get; set; } = "no";
        ...
        [Column("DL_NO", Order = 32, TypeName = "text")]
        public string? DL_NO { get; set; }

        [Column("martital_status", Order = 33, TypeName = "text")]
        public string? martital_status { get; set; }

        [Column("gender", Order = 34, TypeName = "text")]
        public string? gender { get; set; }

        [Column("dob", Order = 35, TypeName = "datetime")]
        public DateTime? dob { get; set; }

        [Column("anniversary", Order = 36, TypeName = "datetime")]
        public DateTime? anniversary { get; set; }


        [Column("loyalty", Order = 37, TypeName = "text")]
        public string? loyalty { get; set; }

        [Column("important", Order = 38, TypeName = "text")]
        public string? important { get; set; }

        [Column("relation_type", Order = 39, TypeName = "text")]
        public string? relation_type { get; set; }

        [Column("swh_Name", Order = 40, TypeName = "text")]
        public string? swh_Name { get; set; }


        [Column("case_master_case_no", Order = 41, TypeName = "text")]
        public string? case_master_case_no { get; set; }
        

        [Column("delete_at", Order = 42, TypeName = "bigint")]
        public long? delete_at { get; set; } = 0;

        [Column("old_software_code_ya_id", Order = 43, TypeName = "bigint")]
        public long? old_software_code_ya_id { get; set; }

        [Column("status_option", Order = 44, TypeName = "text")]
        public string? status_option { get; set; }
