...
namespace DB.Login.Tables
{
    public class IssueReceiptTransDetail
    {
        ...
        public double? issue_qty { get; set; } = 0;

        [Column("recv_qty", Order = 12, TypeName = "decimal(18,2)")]
        public double? recv_qty { get; set; } = 0;
        ...
        [Column("aggrement_id", Order = 20, TypeName = "bigint")]
        ...
        [Column("old_software_code_ya_id", Order = 40, TypeName = "bigint")]
        public long? old_software_code_ya_id { get; set; }


        [Column("item_warranty_mode", Order = 41, TypeName = "text")]
        public string? item_warranty_mode { get; set; }

        [Column("item_warranty_period", Order = 42, TypeName = "text")]
        public string? item_warranty_period { get; set; }

        [Column("item_warranty_visit_count", Order = 43, TypeName = "text")]
        public string? item_warranty_visit_count { get; set; }

        [Column("warranty_serial_no", Order = 44, TypeName = "text")]
        public string? warranty_serial_no { get; set; }

        [Column("item_warranty_expiry_date", Order = 45, TypeName = "datetime")]
