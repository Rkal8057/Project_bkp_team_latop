...
namespace DB.Login.Tables
{
    public class ItemMaster
    {
        ...
        [Column("item_short_name", Order = 2, TypeName = "text")]
        ...
        [Column("group_id", Order = 5, TypeName = "bigint")]
        public long? group_id { get; set; }

        [Column("hsn_code", Order = 6, TypeName = "text")]
        public string? hsn_code { get; set; }

        [Column("tax_per", Order = 7, TypeName = "text")]
        public string? tax_per { get; set; }

        [Column("convertion_of_pcs", Order = 8, TypeName = "text")]
        public string? convertion_of_pcs { get; set; }

        [Column("price_purchase_rate", Order = 9, TypeName = "decimal(18,2)")]
        public decimal? price_purchase_rate { get; set; }

        [Column("price_value_per_pcs", Order = 10, TypeName = "decimal(18,2)")]
        public decimal? price_value_per_pcs { get; set; }

        [Column("price_avg_weight_per_pcs", Order = 11, TypeName = "decimal(18,2)")]
        public decimal? price_avg_weight_per_pcs { get; set; }

        [Column("price_opening_stock_rate", Order = 12, TypeName = "decimal(18,2)")]
        public decimal? price_opening_stock_rate { get; set; }

        [Column("opening_stock_shop", Order = 13, TypeName = "decimal(18,2)")]
        public decimal? opening_stock_shop { get; set; }

        [Column("stock_shop", Order = 14, TypeName = "decimal(18,2)")]
        public decimal? stock_shop { get; set; }

        [Column("opening_stock_godown", Order = 15, TypeName = "decimal(18,2)")]
        public decimal? opening_stock_godown { get; set; }

        [Column("stock_godown", Order = 16, TypeName = "decimal(18,2)")]
        public decimal? stock_godown { get; set; }

        [Column("total_stock", Order = 17, TypeName = "decimal(18,2)")]
        public decimal? total_stock { get; set; }

        [Column("item_type", Order = 18, TypeName = "text")]
        public string? item_type { get; set; }

        [Column("delete_at", Order = 19, TypeName = "bigint")]
        public long? delete_at { get; set; } = 0;

        [Column("item_packing_type", Order = 20, TypeName = "text")]
        ...
        [Column("old_software_code_ya_id", Order = 51, TypeName = "bigint")]
        public long? old_software_code_ya_id { get; set; }

        [Column("warranty_yes_no", Order = 52, TypeName = "text")]
        public string? warranty_yes_no { get; set; }

        [Column("warranty_period", Order = 53, TypeName = "text")]
        public string? warranty_period { get; set; }

        [Column("item_date", Order = 54, TypeName = "datetime")]
