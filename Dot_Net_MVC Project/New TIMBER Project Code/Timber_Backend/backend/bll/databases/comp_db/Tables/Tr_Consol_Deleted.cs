...
{
   [Table ("tr_consol_deleted")] 
       
   public class Tr_Consol_Deleted
   {
       ...
       [Column("old_distno", Order = 12, TypeName = "varchar(50)")]
       public string? old_distno { get; set; }

       [Column("certno", Order = 13, TypeName = "varchar(250)")]
       public string? certno { get; set; }

       [Column("pr_certno", Order = 14, TypeName = "varchar(1000)")]
       public string? pr_certno { get; set; }

       [Column("old_certno", Order = 15, TypeName = "varchar(50)")]
