...
{
   [Table ("index_tmp_promoter_list2")] 
       
   public class Index_Tmp_Promoter_List2
   {
       ...
       [Column("share_lockin_qty", Order = 4, TypeName = "float")]
       public long? share_lockin_qty { get; set; }

       [Column("ben_positi", Order = 5, TypeName = "float")]
       public long? ben_positi { get; set; }

       [Column("benlock", Order = 6, TypeName = "float")]
       public long? benlock { get; set; }

       [Column("benblk", Order = 7, TypeName = "float")]
       public long? benblk { get; set; }

       [Column("benplg", Order = 8, TypeName = "float")]
       public long? benplg { get; set; }

       [Column("benplglk", Order = 9, TypeName = "float")]
       public long? benplglk { get; set; }

       [Column("benplgun", Order = 10, TypeName = "float")]
       public long? benplgun { get; set; }

       [Column("benplgcloc", Order = 11, TypeName = "float")]
       public long? benplgcloc { get; set; }

       [Column("benrem", Order = 12, TypeName = "float")]
       public long? benrem { get; set; }

       [Column("benremloc", Order = 13, TypeName = "float")]
       public long? benremloc { get; set; }

       [Column("bencmidpos", Order = 14, TypeName = "float")]
       public long? bencmidpos { get; set; }

       [Column("cmpool", Order = 15, TypeName = "float")]
       ...
       [Column("fstnm", Order = 18, TypeName = "varchar(164)")]
       public string? fstnm { get; set; }

       [Column("sndnm", Order = 19, TypeName = "varchar(164)")]
       public string? sndnm { get; set; }

       [Column("thdnm", Order = 20, TypeName = "varchar(164)")]
       public string? thdnm { get; set; }

       [Column("fname", Order = 21, TypeName = "varchar(50)")]
       public string? fname { get; set; }

       [Column("sta", Order = 22, TypeName = "float")]
       public long? sta { get; set; }

       [Column("pan_no", Order = 23, TypeName = "varchar(25)")]
       ...
       [Column("city", Order = 27, TypeName = "varchar(25)")]
       public string? city { get; set; }

       [Column("state", Order = 28, TypeName = "varchar(25)")]
       public string? state { get; set; }

       [Column("country", Order = 29, TypeName = "varchar(25)")]
       ...
       [Column("bankdet", Order = 32, TypeName = "varchar(100)")]
       public string? bankdet { get; set; }

       [Column("mobno", Order = 33, TypeName = "varchar(17)")]
       ...
       [Column("foliono_number", Order = 37, TypeName = "varchar(8)")]
