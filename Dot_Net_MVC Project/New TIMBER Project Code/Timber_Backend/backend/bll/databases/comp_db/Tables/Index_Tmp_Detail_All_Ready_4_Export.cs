...
{
   [Table ("index_tmp_detail_all_ready_4_export")] 
       
   public class Index_Tmp_Detail_All_Ready_4_Export
   {
       ...
       [Column("blockreaso", Order = 52, TypeName = "varchar(1)")]
       ...
       [Column("paid_up_capital", Order = 55, TypeName = "bigint(10)")]
       ...
       [Column("c_comp_name", Order = 66, TypeName = "varchar(25)")]
       public string? c_comp_name { get; set; }

       [Column("c_address", Order = 67, TypeName = "varchar(41)")]
