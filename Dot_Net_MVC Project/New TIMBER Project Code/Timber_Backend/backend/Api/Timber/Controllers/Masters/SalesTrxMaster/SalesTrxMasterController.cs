...
namespace Rta.Controllers.Masters
{
    ...
    public class SalesTrxMasterController : Controller
    {
        ...
        public IActionResult GetSalesTrxMasterRecords([FromHeader] long Token_ID,
    [FromHeader] string Token_Data)
        ...
        [Produces("application/json", Type = typeof(SalesTrxMasterResp))]
        public IActionResult GetSalesTrxMasterByID(
       ...
       int id)
        {
            try
            {
                ...
                if (!commonAuth.VerifyFormRights(modelAuth, 1, "DELETE")) // Adjusted to use "DELETE"
                {
                    return Unauthorized(new SalesTrxMasterResp()
                    {
                        status = false,
                        Message = modelAuth.message
                    });
        ...
        [HttpPost("create")]
        [Produces("application/json", Type = typeof(SalesTrxMasterResp))]
        public IActionResult InsertSalesTrxMasterByID(
            [FromHeader] long Token_ID,
            [FromHeader] string Token_Data,
            List<SalesTrxMasterReq> Data,
            long grand_total,
        ...
        [HttpPut("update")]
        [Produces("application/json", Type = typeof(SalesTrxMasterResp))]
        public IActionResult UpdateSalesTrxMaster(
            [FromHeader] long Token_ID,
            [FromHeader] string Token_Data,
            long sale_master_id,
        ...
        [HttpDelete("delete")]
        [Produces("application/json", Type = typeof(SalesTrxMasterResp))]
        public IActionResult DeleteSalesTrxMaster(
            [FromHeader] long Token_ID,
            [FromHeader] string Token_Data,
            int id)
        {
