...
namespace Rta.Controllers.Admin
{
    ...
    public class User_DetailController : ControllerBase
    {
        ...
        public User_DetailController(IConfiguration config)
        {
            ...
            VendorCode = RTAAPI.DB.GetVendorCode(Configurations);
            ...
            )
        {
            try
            {
                ...
                RTA.Admin.UsersMstBLL um = new RTA.Admin.UsersMstBLL(DBConnStr,VendorCode);
        ...
        [Produces("application/json", Type = typeof(ModelOTPResp))]
        [Consumes("application/json")]
        public IActionResult LoginWithOtp(
            [FromBody] ModelOTPLoginReq LoginWithOtpReq)
        {
            try
            {
                RTA.Admin.UsersMstBLL um = new RTA.Admin.UsersMstBLL(DBConnStr,VendorCode);
                var Res = um.LoginWithOtp(LoginWithOtpReq);
                IActionResult objAction = CreatedAtAction("LoginWithOtp", Res);
                return objAction;
            }
            catch (Exception ex)
            {
                ModelOTPResp Res = new ModelOTPResp()
                {
                    status = false,
                    Message = ex.Message
                };
        ...
        [HttpGet("ValidateLoginOTP")]
        [Produces("application/json")]
        [Consumes("application/json")]
        public IActionResult ValidateLoginOTP(string identifier, string otp)
        {
            try
            {
                RTA.Admin.UsersMstBLL um = new RTA.Admin.UsersMstBLL(DBConnStr,VendorCode);
                var Res = um.ValidateOTPforLogin(identifier, otp);
                IActionResult objAction = CreatedAtAction("ValidateLoginOTP", Res);
                return objAction;
            }
            catch (Exception ex)
            {
        ...
        [HttpGet("ValidateMobileOTPforRegistration")]
        [Produces("application/json")]
        [Consumes("application/json")]
        public IActionResult ValidateMobileOTPforRegistration(string mobile, string otp)
        {
            try
            {
                RTA.Admin.UsersMstBLL um = new RTA.Admin.UsersMstBLL(DBConnStr,VendorCode);
                var Registration = um.ValidateMobileOTPforRegistration(mobile, otp);
                IActionResult objAction = CreatedAtAction("ValidateMobileOTPforRegistration", Registration);
                return objAction;
            }
            catch (Exception ex)
            {
                ...
                IActionResult objAction = CreatedAtAction("ValidateMobileOTPforRegistration", res);
                return objAction;
            }
        }       

        [HttpGet("ValidateEmailOTPforRegistration")]
        [Produces("application/json")]
        [Consumes("application/json")]
        public IActionResult ValidateEmailOTPforRegistration(string email, string otp)
        {
            try
            {
                RTA.Admin.UsersMstBLL um = new RTA.Admin.UsersMstBLL(DBConnStr,VendorCode);
                var Registration = um.ValidateEmailOTPforRegistration(email, otp);
                IActionResult objAction = CreatedAtAction("ValidateEmailOTPforRegistration", Registration);
                return objAction;
            }
            catch (Exception ex)
            {
                ...
                IActionResult objAction = CreatedAtAction("ValidateEmailOTPforRegistration", res);
                return objAction;
            }
        }       
        ...
        [HttpGet("GenerateMobileOTP")]
        [Produces("application/json")]
        [Consumes("application/json")]
        public IActionResult GenerateMobileOTP(string mobile, string otp_purpose, long? urn)
        {
            try
            {
                RTA.Admin.UsersMstBLL um = new RTA.Admin.UsersMstBLL(DBConnStr,VendorCode);
                var Registration = um.GenerateMobileOTP(mobile, otp_purpose,null,urn,null);
                IActionResult objAction = CreatedAtAction("GenerateMobileOTP", Registration);
                return objAction;
            }
            catch (Exception ex)
            {
                ...
                IActionResult objAction = CreatedAtAction("GenerateMobileOTP", res);
                return objAction;
            }
        }
        ...
        [HttpGet("GenerateEmailOTP")]
        [Produces("application/json")]
        [Consumes("application/json")]
        public IActionResult GenerateEmailOTP(string email, string otp_purpose,long? userId)
        {
            try
            {
                RTA.Admin.UsersMstBLL um = new RTA.Admin.UsersMstBLL(DBConnStr,VendorCode);
                var Registration = um.GenerateEmailOTP(email, otp_purpose,userId,null,null);
                IActionResult objAction = CreatedAtAction("GenerateEmailOTP", Registration);
                return objAction;
            }
            catch (Exception ex)
            {
                ...
                IActionResult objAction = CreatedAtAction("GenerateEmailOTP", res);
                return objAction;
            }
        }
     ...
     [FromBody] ModelUserMultiAddReq samp)

        {
            ...
            {
                ModelAuth modelAuth = commonAuth.Login_Auth(Token_ID, Token_Data);
                RTA.Admin.UsersMstBLL sample = new RTA.Admin.UsersMstBLL(DBConnStr,VendorCode);
