...
namespace DB.RTAComp.Tables
{
   ...
   public class System_Records
   {
       ...
       [Column("rc_bill_header_name", Order = 58, TypeName = "varchar(50)")]
       ...
       [Column("data_validation_check_yn", Order = 61, TypeName = "varchar(3)")]
