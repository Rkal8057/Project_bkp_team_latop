...
{
   [Table ("index_tmp_detail_all")] 
       
   public class Index_Tmp_Detail_All
   {
       ...
       [Column("cdsl_unique_code", Order = 105, TypeName = "varchar(50)")]
       public string? cdsl_unique_code { get; set; }

       [Column("rpt_auto_id", Order = 106, TypeName = "bigint(10)")]
